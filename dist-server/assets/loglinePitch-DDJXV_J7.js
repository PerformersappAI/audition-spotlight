const loglinePitch = {
  ...
  subtitle: "Your logline is the first thing anyone reads — and often the only thing. Learn to distill your movie into one irresistible sentence, then build it into a pitch package that actually gets your film made.",
  level: "Beginner",
  ...
  pairsWithDesc: "Turn your logline and story into a professional pitch deck. The Pitch Deck Maker builds the visual package financiers and producers expect — title, logline, synopsis, look, and comps — in minutes.",
  seoTitle: "How to Write a Logline & Pitch Your Movie: Free Course | Filmmaker Genius",
  seoDesc: "Learn how to write a logline and build a pitch that sells your film — free. A 12-chapter course on the logline formula, the one-sheet, synopsis, pitch deck, and the verbal pitch, taught by a working filmmaker.",
  learn: [
  ...
  chapters: [
    {
      ...
      seoDesc: "What a logline is, why it's the most important sentence you'll write, and how it differs from a tagline or synopsis. Chapter 1 of Writing the Logline & Pitch Document.",
      body: `
...
`,
    ...
    },
    {
      ...
      seoDesc: "The logline formula — protagonist, inciting incident, goal, and stakes — and a fill-in template you can use on any story. Chapter 2 of Writing the Logline & Pitch Document.",
      body: `
...
`,
    ...
    },
    {
      ...
      seoDesc: "Real logline examples across genres, broken down piece by piece so you can see exactly what makes a logline sell. Chapter 3 of Writing the Logline & Pitch Document.",
      body: `
...
`,
    ...
    },
    {
      ...
      seoDesc: "The most common logline mistakes — vague, crowded, no stakes, naming characters — and how to catch and fix each one in your own logline. Chapter 4 of Writing the Logline & Pitch Document.",
      body: `
...
`,
    ...
    },
    {
      ...
      seoDesc: "How to expand a one-sentence logline into a full film pitch — the hook, synopsis, tone, comps, and the 'why now, why you' that sells a project. Chapter 5 of Writing the Logline & Pitch Document.",
      body: `
...
`,
    ...
    },
    {
      ...
      seoDesc: "How to build a film one-sheet (one-pager) — title, logline, synopsis, comps, and the why-now/why-you that packages your project on a single page. Chapter 6 of Writing the Logline & Pitch Document.",
      body: `
...
`,
    ...
    },
    {
      ...
      seoDesc: "How to write a film synopsis and a treatment — the difference between them, how long each should be, and how to tell your whole story in prose that sells. Chapter 7 of Writing the Logline & Pitch Document.",
      body: `
...
`,
    ...
    },
    {
      ...
      seoDesc: "How to build a film pitch deck — the slide-by-slide anatomy of a pitch that packages your logline, synopsis, tone, look, and team into a document producers take seriously. Chapter 8 of Writing the Logline & Pitch Document.",
      body: `
...
`,
    ...
    },
    {
      ...
      seoDesc: "How to pitch a movie out loud — structuring the verbal pitch, opening with the hook, handling nerves, and leaving room for a conversation. Chapter 9 of Writing the Logline & Pitch Document.",
      body: `
...
`,
    ...
    },
    {
      ...
      seoDesc: "How to tailor your movie pitch to different buyers — producers, financiers, studios, streamers, and festival programmers each listen for different things. Chapter 10 of Writing the Logline & Pitch Document.",
      body: `
...
`,
    ...
    },
    {
      ...
      seoDesc: "How to write a film query letter and cold outreach email that gets your script requested — subject line, the hook, credentials, and the ask. Chapter 11 of Writing the Logline & Pitch Document.",
      body: `
...
`,
    ...
    },
    {
      ...
      seoDesc: "How to test and refine your movie pitch — reading real reactions, A/B testing your logline, spotting the confusion, and iterating until it lands every time. Chapter 12, the finale of Writing the Logline & Pitch Document.",
      body: `
