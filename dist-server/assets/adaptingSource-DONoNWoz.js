const adaptingSource = {
  slug: "adapting-source-material",
  title: "Adapting Source Material for the Screen",
  categoryLabel: "Development & Writing",
  subtitle: "The book, the article, the true story you can't stop thinking about — this is how you turn it into a screenplay. Optioning the rights, choosing what to cut, translating prose into pictures, and staying faithful without staying stuck. Written from the set by a working filmmaker.",
  level: "Intermediate",
  chapterCount: "12 Chapters",
  readTime: "~105 min read",
  pairsWithName: "Filmmaker Toolbox",
  pairsWithUrl: "/toolbox",
  pairsWithDesc: "Break down your source material, outline the adaptation, and draft your script in one place. The Toolbox turns the messy work of adaptation — beat-mapping a novel, tracking what you cut — into a clear, structured workflow.",
  seoTitle: "How to Adapt a Book into a Screenplay: Free Adaptation Course | Filmmaker Genius",
  seoDesc: "A free, chapter-by-chapter course on adapting source material for the screen — how to option a book, choose what to cut, translate prose to visuals, and adapt novels, short stories, and true stories into a screenplay.",
  learn: [
  ...
  chapters: [
    {
      ...
      seoDesc: "Why adaptation is one of the surest paths into the film industry — how book-to-film adaptation lowers risk, attracts talent and finance, and gives a new filmmaker a built-in audience. Chapter 1 of Adapting Source Material for the Screen.",
      body: `
...
`,
    ...
    },
    {
      ...
      seoDesc: "How to choose the right book or story to adapt into a film — the traits that make source material cinematic, the red flags to avoid, and why the best novel is rarely the best adaptation. Chapter 2 of Adapting Source Material for the Screen.",
      body: `
...
`,
    ...
    },
    {
      ...
      seoDesc: "How to get the film rights to a book — what an option agreement is, how much rights cost, life rights and public domain, and the legal steps to secure source material before you adapt. Chapter 3 of Adapting Source Material for the Screen.",
      body: `
...
`,
    ...
    },
    {
      ...
      seoDesc: "How to read a book for adaptation — the active, screenwriter's read that maps scenes, marks what's cinematic, and finds the movie hiding inside the prose. Chapter 4 of Adapting Source Material for the Screen.",
      body: `
...
`,
    ...
    },
    {
      ...
      seoDesc: "How to decide what to cut and what to keep when adapting a book into a screenplay — compressing subplots, combining characters, and protecting the story's essential moments. Chapter 5 of Adapting Source Material for the Screen.",
      body: `
...
`,
    ...
    },
    {
      ...
      seoDesc: "How to adapt a novel into a screenplay by finding its spine — the single dramatic through-line that turns a sprawling book into a two-hour film with one protagonist, one want, one arc. Chapter 6 of Adapting Source Material for the Screen.",
      body: `
...
`,
    ...
    },
    {
      ...
      seoDesc: "How to adapt a book into a screenplay — the core craft of turning prose, description, and interior thought into visual, dramatic, present-tense scenes. With a before-and-after example. Chapter 7 of Adapting Source Material for the Screen.",
      body: `
...
`,
    ...
    },
    {
      ...
      seoDesc: "How to adapt internal monologue to film — externalizing a character's thoughts, memory, and inner life into action and image, and using voice-over well instead of as a crutch. Chapter 8 of Adapting Source Material for the Screen.",
      body: `
...
`,
    ...
    },
    {
      ...
      seoDesc: "How to write a based-on-a-true-story screenplay — structuring real events, life rights and legal safety, dramatic license, and turning a messy true story into a shaped biopic. Chapter 9 of Adapting Source Material for the Screen.",
      body: `
...
`,
    ...
    },
    {
      ...
      seoDesc: "How to adapt a short story into a film — expanding rather than cutting, building out characters and world, and adapting magazine articles, games, and other IP. Chapter 10 of Adapting Source Material for the Screen.",
      body: `
...
`,
    ...
    },
    {
      ...
      seoDesc: "Faithful vs. loose adaptation — how faithful to be to the source, when to make it your own, and how to honor the spirit of a book while serving the film. Chapter 11 of Adapting Source Material for the Screen.",
      body: `
...
`,
    ...
    },
    {
      ...
      seoDesc: "The most common adaptation mistakes to avoid — cramming in too much, staying too faithful, keeping interiority as voice-over, and losing the spine. The pitfalls that trap first-time adapters, and how to sidestep them. Chapter 12, the finale of Adapting Source Material for the Screen.",
      body: `
