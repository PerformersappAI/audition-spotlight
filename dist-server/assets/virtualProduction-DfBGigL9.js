...
const virtualProduction = {
  ...
  subtitle: "The Mandalorian made LED walls famous — but virtual production isn't just a studio toy anymore. What the technology actually is, what it really costs, when it beats a location or a green screen, and how indie filmmakers are already using it, down to the at-home version.",
  level: "Beginner",
  chapterCount: "12 Chapters",
  readTime: "~95 min read",
  pairsWithName: "Filmmaker Toolbox",
  pairsWithUrl: "/toolbox",
  pairsWithDesc: "Virtual production is planning-heavy — and planning is what the Filmmaker Toolbox does. Break down the script, board the sequences, and budget the volume days before you book a single hour of stage time.",
  seoTitle: "Virtual Production & LED Walls for Indie Filmmakers (Free Course) | Filmmaker Genius",
  seoDesc: "Virtual production explained for indie filmmakers — LED volumes, Unreal Engine, camera tracking, in-camera VFX, real costs, and the at-home version. A free 12-chapter course by a working filmmaker.",
  learn: [
