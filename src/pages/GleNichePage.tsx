  ...
  if (!data) {
    return (
      <div style={{ background: "#14181c", minHeight: "60vh", color: "#fff", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", fontFamily: "system-ui, -apple-system, sans-serif", padding: "80px 20px", textAlign: "center" }}>
        ...
        <p style={{ color: "#9ab1c2", marginBottom: 22 }}>This niche detail is on the way.</p>
        <Link to="/green-light-engine/niche" style={{ background: "#20272e", border: "1px solid #2c3440", color: "#fff", fontWeight: 700, fontSize: 14, borderRadius: 9, padding: "10px 16px", textDecoration: "none" }}>← Back to Niche</Link>
      </div>
    );
  }
    ...
    <div style={{ background: "#14181c", color: "#fff", fontFamily: "system-ui, -apple-system, Segoe UI, Roboto, sans-serif", minHeight: "100vh" }}>
      ...
      <main style={{ maxWidth: 1100, margin: "0 auto", padding: "40px 22px 60px" }}>
        <div style={{ display: "flex", gap: 12, marginBottom: 26, flexWrap: "wrap", alignItems: "center" }}>
          <Link to="/green-light-engine/niche" className="gle-back" style={{ background: "#20272e", border: "1px solid #2c3440", color: "#fff", fontWeight: 700, fontSize: 14, borderRadius: 9, padding: "10px 16px", textDecoration: "none" }}>← Back to Niche</Link>
          <div style={{ fontSize: 13, color: "#678" }}>
            ...
            <Link to="/green-light-engine/niche" style={{ color: "#9ab1c2", textDecoration: "none" }}>Niche & Identity</Link>
            <span style={{ color: "#456" }}> › </span>
            <span>{title}</span>
          </div>
        </div>
