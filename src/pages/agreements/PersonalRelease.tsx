...
const INITIAL_FORM: PersonalReleaseForm = {
  production_name: "",
  company: "",
  person_name: "",
  effective_date: "",
...
const PersonalRelease = () => {
  const [form, setForm] = useState<PersonalReleaseForm>(INITIAL_FORM);
  ...
  const set = <K extends keyof PersonalReleaseForm>(key: K, value: PersonalReleaseForm[K]) =>
  ...
  const intro = `This Personal Release ("Release") is entered into as of ${v(
    formatDate(form.effective_date),
    "effective date"
  )} by and between ${v(form.company, "producer / filmmaker")} and ${v(form.person_name, "person name")}.`;

  const clauses: Clause[] = [
    {
      heading: "Grant of Rights",
      body: `In connection with the project presently entitled ${v(
        form.production_name,
        "production / project"
      )} (${v(form.project_description, "project description")}), ${v(
        form.person_name,
        "person name"
      )} ("Person") grants ${v(form.company, "producer / filmmaker")} ("Producer") the irrevocable, perpetual right to photograph, film, record, and use the Person's name, likeness, image, voice, and appearance, and to edit, reproduce, exhibit, distribute, and otherwise use the same in any and all media now known or hereafter devised, throughout the world, including for promotion of the project.`,
    },
    {
      heading: "Consideration",
      body: `In consideration of ${v(form.consideration, "consideration")}, the receipt and sufficiency of which are acknowledged, the Person grants the rights set forth herein.`,
    },
    {
      heading: "Ownership",
      body: "All recordings and materials containing the Person's appearance shall be the sole property of Producer, who shall own all rights therein, and the Person shall have no right, title, or interest in them.",
    },
    {
      heading: "Release & Waiver",
      body: "The Person releases Producer and its assigns from any and all claims arising out of the use described herein, including claims for invasion of privacy, right of publicity, or defamation, and waives any right to inspect or approve the finished materials.",
    },
    {
      heading: "Representations & Warranties",
      body: "The Person represents that they are at least eighteen (18) years of age and are free to grant these rights.",
    },
    {
    ...
    },
    {
      ...
      body: `This Release shall be governed by the laws of ${v(
        form.governing_law,
        "governing law"
  ...
  const buildPDF = () => {
    ...
    write("PERSONAL RELEASE", 16, "bold", "center");
    y += 6;
    write(intro);
    y += 4;
    ...
    y += 10;
    write("PERSON", 11, "bold");
    y += 2;
    write("Signature: ______________________________");
    write(`Printed Name: ${v(form.person_name, "person name")}`);
    write("Date: __________________________________");
    y += 8;
    write("PRODUCER", 11, "bold");
    y += 2;
    write("Signature: ______________________________");
    write(`Printed Name: ${v(form.company, "producer / filmmaker")}`);
    write("Date: __________________________________");
    y += 12;
  ...
  const handleDownload = () => {
    const base = `${form.production_name || "Personal"}_${form.person_name || "Release"}`.replace(
      /[^a-zA-Z0-9]/g,
      "_"
    );
    buildPDF().save(`${base}_Personal_Release.pdf`);
  };
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-6 py-8">
        <div className="text-center mb-6">
          <h1 className="text-3xl font-bold mb-2">Personal Release</h1>
          <p className="text-muted-foreground">
            A simple, general-purpose release for friends, family, or private individuals on camera.
          </p>
        </div>
          ...
          <div className="grid md:grid-cols-2 md:divide-x divide-border gap-8 md:gap-0">
            <div className="md:pr-10 space-y-4">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground leading-relaxed list-disc list-inside">
                <li>Small crews filming friends and family.</li>
                <li>Student and no-budget shoots.</li>
                <li>Anyone needing a quick, plain-language release.</li>
              </ul>
            </div>
            <div className="md:pl-10 space-y-4">
              <h2 className="text-xs font-semibold uppercase tracking-widest text-primary">What It's For</h2>
              <ul className="space-y-2 text-sm text-muted-foreground leading-relaxed list-disc list-inside">
                <li>Grants the right to record and use an appearance.</li>
                <li>Keeps the language short and general.</li>
          ...
          <div className="space-y-6">
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  <Label htmlFor="production_name">Production / Project</Label>
                  <Input
                    id="production_name"
                ...
                <div>
                  <Label htmlFor="company">Producer / Filmmaker</Label>
                  <Input
                    id="company"
                    value={form.company}
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <Textarea
                    ...
                    rows={3}
                    placeholder="The project — title, format, brief description…"
                    value={form.project_description}
                    onChange={(e) => set("project_description", e.target.value)}
                  />
                  {aiButton("project_description", "personal release — production description")}
                </div>
                <div>
                ...
                <div>
                  ...
                  />
                  {aiButton("additional_provisions", "personal release — additional provisions")}
                </div>
                <div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="max-h-[70vh] overflow-y-auto rounded-md bg-white p-6 text-[13px] leading-relaxed text-black">
                  <h2 className="mb-4 text-center text-lg font-bold">PERSONAL RELEASE</h2>
                  ...
                  <div className="mt-6 grid grid-cols-2 gap-6">
                    <div>
                      ...
                      <p className="mt-2">Printed Name: {v(form.person_name, "person name")}</p>
                      <p className="mt-2">Date: ____________________</p>
                    </div>
                    <div>
                      <p className="font-bold">PRODUCER</p>
                      <p className="mt-3">Signature: ____________________</p>
                      <p className="mt-2">Printed Name: {v(form.company, "producer / filmmaker")}</p>
                      <p className="mt-2">Date: ____________________</p>
                    </div>
                  </div>
...
export default PersonalRelease;
