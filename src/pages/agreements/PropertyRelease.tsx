...
const INITIAL_FORM: PropertyReleaseForm = {
  production_name: "",
  company: "",
  owner_name: "",
  effective_date: "",
...
type AiField = "property_description" | "project_description" | "additional_provisions";

const PropertyRelease = () => {
  const [form, setForm] = useState<PropertyReleaseForm>(INITIAL_FORM);
  ...
  const set = <K extends keyof PropertyReleaseForm>(key: K, value: PropertyReleaseForm[K]) =>
  ...
  const intro = `This Property Release ("Release") is entered into as of ${v(
    formatDate(form.effective_date),
    "effective date"
  )} by and between ${v(form.company, "producer / company")} and ${v(form.owner_name, "property owner")}.`;
  ...
  const clauses: Clause[] = [
    {
      ...
      body: `In connection with the production presently entitled ${v(
        ...
        form.owner_name,
        "property owner"
      )} ("Owner") grants ${v(form.company, "producer / company")} ("Company") the irrevocable, perpetual right to photograph, film, record, and use the following property: ${v(
        form.property_description,
        "description of the property"
      )}, and to reproduce, edit, exhibit, distribute, and otherwise exploit its appearance in any and all media now known or hereafter devised, throughout the universe, in perpetuity, including for advertising and promotion.`,
    },
    {
      heading: "Consideration",
      body: `In consideration of ${v(form.consideration, "consideration")}, the receipt and sufficiency of which are hereby acknowledged, the Owner grants the rights set forth herein.`,
    },
    {
      heading: "Ownership",
      body: "All footage and materials embodying the property shall be the sole and exclusive property of Company, which shall own all rights therein, including all copyrights, and the Owner shall have no right, title, or interest therein.",
    },
    {
      heading: "Release & Waiver",
      body: "The Owner releases and discharges Company and its licensees, successors, and assigns from any and all claims arising out of the use of the property described herein, including claims based on ownership, trademark, copyright, invasion of privacy, or any similar claim, and waives any right to inspect or approve the finished materials or the use to which they may be applied.",
    },
    {
      heading: "Representations & Warranties",
      body: "The Owner represents and warrants that the Owner owns or controls the property described herein and has full authority to grant the rights set forth herein.",
    },
    {
  ...
  const buildPDF = () => {
    ...
    write("PROPERTY RELEASE", 16, "bold", "center");
    y += 6;
    write(intro);
    y += 4;
    ...
    y += 10;
    write("PROPERTY OWNER", 11, "bold");
    y += 2;
    write("Signature: ______________________________");
    write(`Printed Name: ${v(form.owner_name, "property owner")}`);
  ...
  const handleDownload = () => {
    const base = `${form.production_name || "Property"}_${form.owner_name || "Release"}`.replace(
      /[^a-zA-Z0-9]/g,
      "_"
    );
    buildPDF().save(`${base}_Property_Release.pdf`);
  };
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-6 py-8">
        <div className="text-center mb-6">
          <h1 className="text-3xl font-bold mb-2">Property Release</h1>
          <p className="text-muted-foreground">
            Clear a specific object, artwork, building, or item of property to appear on camera.
          </p>
        </div>
          ...
          <div className="grid md:grid-cols-2 md:divide-x divide-border gap-8 md:gap-0">
            <div className="md:pr-10 space-y-4">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground leading-relaxed list-disc list-inside">
                <li>Productions filming identifiable property or art.</li>
                <li>Location and clearance coordinators.</li>
                <li>Owners granting rights to depict their property.</li>
              </ul>
            </div>
            <div className="md:pl-10 space-y-4">
              <h2 className="text-xs font-semibold uppercase tracking-widest text-primary">What It's For</h2>
              <ul className="space-y-2 text-sm text-muted-foreground leading-relaxed list-disc list-inside">
                <li>Grants the right to depict a specific property.</li>
                <li>Covers objects, artwork, buildings, and logos.</li>
                <li>Releases property-based and related claims.</li>
              </ul>
            </div>
          </div>
        </section>
          ...
          <div className="space-y-6">
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  <Label htmlFor="owner_name">Property Owner</Label>
                  <Input
                    id="owner_name"
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <Textarea
                    ...
                    rows={3}
                    placeholder="Describe the property, object, artwork, or building being cleared…"
                    value={form.property_description}
                    onChange={(e) => set("property_description", e.target.value)}
                  />
                  {aiButton("property_description", "property release — description of the property")}
                </div>
                <div>
                  ...
                  />
                  {aiButton("project_description", "property release — production description")}
                </div>
                <div>
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    rows={4}
                    placeholder="Any limits on use, special terms, or attribution…"
                    value={form.additional_provisions}
                    onChange={(e) => set("additional_provisions", e.target.value)}
                  />
                  {aiButton("additional_provisions", "property release — additional provisions")}
                </div>
                <div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="max-h-[70vh] overflow-y-auto rounded-md bg-white p-6 text-[13px] leading-relaxed text-black">
                  <h2 className="mb-4 text-center text-lg font-bold">PROPERTY RELEASE</h2>
                  ...
                  <div className="mt-6 grid grid-cols-2 gap-6">
                    <div>
                      ...
                      <p className="mt-2">Printed Name: {v(form.owner_name, "property owner")}</p>
