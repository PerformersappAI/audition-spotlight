...
interface InterviewSubjectReleaseForm {
...
const INITIAL_FORM: InterviewSubjectReleaseForm = {
  production_name: "",
  company: "",
  subject_name: "",
  effective_date: "",
...
const InterviewSubjectRelease = () => {
  const [form, setForm] = useState<InterviewSubjectReleaseForm>(INITIAL_FORM);
  ...
  const set = <K extends keyof InterviewSubjectReleaseForm>(key: K, value: InterviewSubjectReleaseForm[K]) =>
  ...
  const intro = `This Interview / Subject Release ("Release") is entered into as of ${v(
    formatDate(form.effective_date),
    "effective date"
  )} by and between ${v(form.company, "producer / company")} and ${v(form.subject_name, "interviewee / subject")}.`;
  ...
  const clauses: Clause[] = [
    {
      ...
      body: `In connection with the production presently entitled ${v(
        ...
        form.subject_name,
        "interviewee / subject"
      )} ("Subject") grants ${v(form.company, "producer / company")} ("Company") the irrevocable, perpetual right to record, film, and use the Subject's interview, statements, name, likeness, image, and voice, and to reproduce, edit, exhibit, distribute, and otherwise exploit the same in any and all media now known or hereafter devised, throughout the universe, in perpetuity, including for advertising and promotion.`,
    },
    {
      heading: "Consideration",
      body: `In consideration of ${v(form.consideration, "consideration")}, the receipt and sufficiency of which are hereby acknowledged, the Subject grants the rights set forth herein.`,
    },
    {
      heading: "Ownership & Editorial Control",
      body: "All recordings and materials embodying the interview shall be the sole and exclusive property of Company, which shall own all rights therein, including all copyrights. Company shall have full editorial control and may edit, excerpt, or omit any portion of the interview in its sole discretion, and the Subject shall have no right, title, or interest therein.",
    },
    {
      heading: "Release & Waiver",
      body: "The Subject releases and discharges Company and its licensees, successors, and assigns from any and all claims arising out of the use of the materials described herein, including claims for invasion of privacy, right of publicity, defamation, false light, or any similar claim, and waives any right to inspect or approve the finished materials or the use to which they may be applied.",
    },
    {
      heading: "Representations & Warranties",
      body: "The Subject represents and warrants that they are at least eighteen (18) years of age, that their statements are truthful to the best of their knowledge, and that they are free to grant the rights set forth herein.",
    },
    {
  ...
  const buildPDF = () => {
    ...
    write("INTERVIEW / SUBJECT RELEASE", 16, "bold", "center");
    y += 6;
    write(intro);
    y += 4;
    ...
    y += 10;
    write("INTERVIEWEE / SUBJECT", 11, "bold");
    y += 2;
    write("Signature: ______________________________");
    write(`Printed Name: ${v(form.subject_name, "interviewee / subject")}`);
  ...
  const handleDownload = () => {
    const base = `${form.production_name || "Interview"}_${form.subject_name || "Release"}`.replace(
      /[^a-zA-Z0-9]/g,
      "_"
    );
    buildPDF().save(`${base}_Interview_Subject_Release.pdf`);
  };
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-6 py-8">
        <div className="text-center mb-6">
          <h1 className="text-3xl font-bold mb-2">Interview / Subject Release</h1>
          <p className="text-muted-foreground">
            Clear a documentary interviewee's statements, likeness, and participation for use.
          </p>
        </div>
          ...
          <div className="grid md:grid-cols-2 md:divide-x divide-border gap-8 md:gap-0">
            <div className="md:pr-10 space-y-4">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground leading-relaxed list-disc list-inside">
                <li>Documentary filmmakers interviewing subjects.</li>
                <li>Journalists and nonfiction producers.</li>
                <li>Anyone recording real people's statements.</li>
              </ul>
            </div>
            <div className="md:pl-10 space-y-4">
              <h2 className="text-xs font-semibold uppercase tracking-widest text-primary">What It's For</h2>
              <ul className="space-y-2 text-sm text-muted-foreground leading-relaxed list-disc list-inside">
                <li>Grants rights to the interview and statements.</li>
                <li>Covers likeness, voice, and editorial use.</li>
                <li>Releases claims over privacy and defamation.</li>
              </ul>
            </div>
          </div>
        </section>
          ...
          <div className="space-y-6">
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  <Label htmlFor="production_name">Production / Film</Label>
                  <Input
                    id="production_name"
                ...
                <div>
                  <Label htmlFor="subject_name">Interviewee / Subject</Label>
                  <Input
                    id="subject_name"
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  />
                  {aiButton("project_description", "interview/subject release — production description")}
                </div>
                <div>
                  <Label htmlFor="consideration">Consideration</Label>
                  <Input
                    id="consideration"
                    placeholder="e.g., good and valuable consideration"
                ...
                <div>
                  ...
                  />
                  {aiButton("additional_provisions", "interview/subject release — additional provisions")}
                </div>
                <div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="max-h-[70vh] overflow-y-auto rounded-md bg-white p-6 text-[13px] leading-relaxed text-black">
                  <h2 className="mb-4 text-center text-lg font-bold">INTERVIEW / SUBJECT RELEASE</h2>
                  ...
                  <div className="mt-6 grid grid-cols-2 gap-6">
                    <div>
                      <p className="font-bold">INTERVIEWEE / SUBJECT</p>
                      <p className="mt-3">Signature: ____________________</p>
                      <p className="mt-2">Printed Name: {v(form.subject_name, "interviewee / subject")}</p>
...
export default InterviewSubjectRelease;
