...
interface DepictionAppearanceReleaseForm {
...
const INITIAL_FORM: DepictionAppearanceReleaseForm = {
  production_name: "",
  company: "",
  individual_name: "",
  effective_date: "",
...
const DepictionAppearanceRelease = () => {
  const [form, setForm] = useState<DepictionAppearanceReleaseForm>(INITIAL_FORM);
  ...
  const set = <K extends keyof DepictionAppearanceReleaseForm>(key: K, value: DepictionAppearanceReleaseForm[K]) =>
  ...
  const intro = `This Depiction / Appearance Release ("Release") is entered into as of ${v(
    formatDate(form.effective_date),
    "effective date"
  )} by and between ${v(form.company, "producer / company")} and ${v(form.individual_name, "individual name")}.`;
  ...
  const clauses: Clause[] = [
    {
      ...
      body: `In connection with the production presently entitled ${v(
        ...
        form.individual_name,
        "individual name"
      )} ("Individual") grants ${v(form.company, "producer / company")} ("Company") the irrevocable, perpetual right to photograph, film, record, and use the Individual's appearance, name, likeness, image, voice, and identity, and to reproduce, edit, exhibit, distribute, and otherwise exploit the same in any and all media now known or hereafter devised, throughout the universe, in perpetuity, including for advertising and promotion.`,
    },
    {
      heading: "Consideration",
      body: `In consideration of ${v(form.consideration, "consideration")}, the receipt and sufficiency of which are hereby acknowledged, the Individual grants the rights set forth herein.`,
    },
    {
      heading: "Ownership",
      body: "All footage, recordings, and materials embodying the Individual's appearance shall be the sole and exclusive property of Company, which shall own all rights therein, including all copyrights, and the Individual shall have no right, title, or interest therein.",
    },
    {
      heading: "Release & Waiver",
      body: "The Individual releases and discharges Company and its licensees, successors, and assigns from any and all claims arising out of the use of the materials described herein, including claims for invasion of privacy, right of publicity, defamation, false light, or any similar claim, and waives any right to inspect or approve the finished materials or the use to which they may be applied.",
    },
    {
      heading: "Representations & Warranties",
      body: "The Individual represents and warrants that they are at least eighteen (18) years of age and are free to grant the rights set forth herein.",
    },
    {
  ...
  const buildPDF = () => {
    ...
    write("DEPICTION / APPEARANCE RELEASE", 16, "bold", "center");
    y += 6;
    write(intro);
    y += 4;
    ...
    y += 10;
    write("INDIVIDUAL", 11, "bold");
    y += 2;
    write("Signature: ______________________________");
    write(`Printed Name: ${v(form.individual_name, "individual name")}`);
  ...
  const handleDownload = () => {
    const base = `${form.production_name || "Depiction"}_${form.individual_name || "Release"}`.replace(
      /[^a-zA-Z0-9]/g,
      "_"
    );
    buildPDF().save(`${base}_Depiction_Appearance_Release.pdf`);
  };
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-6 py-8">
        <div className="text-center mb-6">
          <h1 className="text-3xl font-bold mb-2">Depiction / Appearance Release</h1>
          <p className="text-muted-foreground">
            Clear a recognizable individual's appearance and identity for use in the production.
          </p>
        </div>
          ...
          <div className="grid md:grid-cols-2 md:divide-x divide-border gap-8 md:gap-0">
            <div className="md:pr-10 space-y-4">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground leading-relaxed list-disc list-inside">
                <li>Productions capturing recognizable individuals on camera.</li>
                <li>Documentary and location shoots with real people.</li>
                <li>Coordinators clearing on-camera appearances.</li>
              </ul>
            </div>
            <div className="md:pl-10 space-y-4">
              <h2 className="text-xs font-semibold uppercase tracking-widest text-primary">What It's For</h2>
              <ul className="space-y-2 text-sm text-muted-foreground leading-relaxed list-disc list-inside">
                <li>Grants the right to use an individual's appearance.</li>
                <li>Covers name, likeness, voice, and identity.</li>
                <li>Releases claims over privacy and publicity.</li>
              </ul>
            </div>
          </div>
        </section>
          ...
          <div className="space-y-6">
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  <Label htmlFor="individual_name">Individual</Label>
                  <Input
                    id="individual_name"
                    value={form.individual_name}
                    onChange={(e) => set("individual_name", e.target.value)}
                  />
                </div>
                <div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  />
                  {aiButton("project_description", "depiction/appearance release — production description")}
                </div>
                <div>
                  <Label htmlFor="consideration">Consideration</Label>
                  <Input
                    id="consideration"
                    placeholder="e.g., $100, or good and valuable consideration"
                ...
                <div>
                  ...
                  />
                  {aiButton("additional_provisions", "depiction/appearance release — additional provisions")}
                </div>
                <div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="max-h-[70vh] overflow-y-auto rounded-md bg-white p-6 text-[13px] leading-relaxed text-black">
                  <h2 className="mb-4 text-center text-lg font-bold">DEPICTION / APPEARANCE RELEASE</h2>
                  ...
                  <div className="mt-6 grid grid-cols-2 gap-6">
                    <div>
                      ...
                      <p className="mt-2">Printed Name: {v(form.individual_name, "individual name")}</p>
...
export default DepictionAppearanceRelease;
