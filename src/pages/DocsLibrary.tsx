...
const documentBundles = [
  ...
  },
  {
    ...
    documents: [
      ...
      { id: "21", title: "Day Out of Days (DOOD)", description: "Track cast availability and work days across the schedule", category: "preproduction_scheduling", format: "PDF + Word", size: "Fillable", premium: true },
      { id: "22", title: "Shot List", description: "List every camera shot planned for each scene", category: "preproduction_scheduling", format: "PDF + Word", size: "Fillable", premium: true },
      { id: "23", title: "Storyboard Template", description: "Frame-by-frame visual planning template with notes", category: "preproduction_scheduling", format: "PDF + Word", size: "Fillable", premium: true },
      { id: "24", title: "Budget Top Sheet", description: "Summary of the production budget by category", category: "preproduction_scheduling", format: "PDF + Word", size: "Fillable", premium: true },
  ...
  },
  {
    ...
    documents: [
      { id: "37", title: "Adult Talent Release", description: "Release of likeness, voice, and performance from an adult", category: "talent_releases", format: "PDF + Word", size: "Fillable", premium: true },
      { id: "38", title: "Background / Extra Release", description: "Release for background performers appearing on camera", category: "talent_releases", format: "PDF + Word", size: "Fillable", premium: true },
