...
export const aiPost: Course = {
  slug: "ai-in-post-production",
  title: "AI in Post-Production",
  categoryLabel: "AI & Technology",
  subtitle:
    "Post is where AI quietly earns its keep — not by cutting your film, but by killing the drudge work around the cut. Transcription editing, rough-cut assists, color first-passes, audio cleanup, upscaling, and captions: the working filmmaker's guide to finishing faster.",
  level: "Beginner",
  ...
  pairsWithDesc:
    "Recut is this course in tool form — an AI edit assistant that pulls selects from your footage, builds a first assembly, and preps cutdowns, ready to polish in your own editor.",
  seoTitle: "AI in Post-Production: Edit, Color & Sound with AI (Free Course) | Filmmaker Genius",
  seoDesc:
    "AI in post-production, explained by a working filmmaker — text-based editing, AI rough cuts, color first-passes, audio cleanup, upscaling, and captions. A free 12-chapter course on finishing your film faster without losing the craft.",
  learn: [
