...
export const gleTiers: Record<string, GleTier> = {
  "tier-1": {
    ...
    platforms: [
      ...
      { logoText: "a", logoBg: "#00a8e1", name: "Amazon Prime Video", slug: "amazon", desc: "SVOD + rent/buy. Reachable via aggregator or distributor. Huge global reach." },
      { logoText: "h", logoBg: "#1ce783", logoColor: "#0b0f12", name: "Hulu", slug: "hulu", desc: "SVOD / AVOD (US). Indie access through a distributor." },
      { logoText: "", logoBg: "#333", logoBorder: "#555", name: "Apple TV / iTunes", slug: "apple-tv", desc: "Rent/buy (TVOD). Reached via aggregators like Bitmax or Quiver." },
